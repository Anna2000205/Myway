...
define gui.text_font = "gui/font/CaveatRegular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "gui/font/CaveatRegular.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "gui/font/CaveatRegular.ttf"
...
define gui.dialogue_xpos =  0.2 ##268
